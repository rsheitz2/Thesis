...
\begin{figure}[h!t]
  ...
  \begin{subfigure}{.5\textwidth}
    ...
    \label{fig::withLARec}
  \end{subfigure}
  \caption{Reconstruction with and without DC05 included.}
\end{figure}
...
\begin{figure}[h!t]
  \centering \includegraphics[width=0.7\textwidth, trim=0.2cm 7cm 0.2cm 2cm,
    clip]{DC05_layers}
...
\begin{figure}[h!t]
  \centering \includegraphics[width=0.6\textwidth, trim=3cm 9cm 3cm 9cm,
    clip]{DC05Yeff}
...
\begin{figure}[h!t]
  \centering \includegraphics[width=0.6\textwidth, trim=3cm 8cm 3cm 8cm,
    clip]{RT_DC05Y2}
