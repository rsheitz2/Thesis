...
The SIDIS cross-section, Eq.~\ref{equ::SIDISxsect}, is defined in the
...
Give transversity function from SIDIS, get BM convolution and asymmetry...

\begin{figure}[h!t]
  \centering \includegraphics[width=0.75\textwidth, trim=0cm 4cm 0cm 4cm,
    clip]{transversityExtractedFromSIDIS}
  \caption{Image taken from~\cite{PhysRevD.87.094019}.}
...
Give star results on generalized DY
\begin{figure}[h!t]
  \centering
  \includegraphics[width=0.7\textwidth, trim=1cm 5cm 1cm 5cm]{StarSivers}
  \caption{Evolution from EIKV~\cite{PhysRevD.89.074013} and
