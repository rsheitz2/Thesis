...
\begin{figure}[h!t]
  \begin{center}
    ...
    \caption{A$_{\mathrm{N}}$ determined from the geometric mean method for each
      target}
    \label{fig::ANgeom}
  \end{center}
\end{figure}
...
\item A false asymmetries using only the information from the upstream or the
  ...
  upstream and downstream target is shown in Fig.~\ref{fig::alphaAsym} and as
  can be seen there are difference by period between the upstream and downstream
  asymmetries.  A combined pull distribution is made using the information from
  both upstream and downstream asymmetries and is shown in
  ...
  %\begin{figure}[h!t]
  %  \centering
  %  \includegraphics[width=\textwidth]{alphaAsym}
  %  \caption{}
  %  \label{fig::alphaAsym}
  %\end{figure}
...
\item Finally the same false asymmetry used to determine the acceptance
  ...
  \begin{figure}[h!t]
    \centering
    \includegraphics[width=\textwidth, trim=0cm 1.65cm 0cm 0cm, clip]
                    {fa2TargPulls_fit}
    \caption{}
...
%\begin{figure}[h!t]
%  \centering
%  \includegraphics[width=0.6\textwidth]{lrMigration}
...
%\begin{figure}[h!t]
%  \centering
%  \includegraphics[width=0.6\textwidth]{percentLRmiss}
%  \caption{}
...
The systematic error normalized to the statistical error as a function of the
amount of $\phi_{\mathrm{S}}$ cut is shown in Fig.~\ref{fig::sysErrLRPhiScut}.
...
and to avoid loss of statistics.  The final systematic error due to left-right
event migration was determined to be 5\% of the statistical error and add in
quadrature per physics bin.
